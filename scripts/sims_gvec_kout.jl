...
filename_preamble = smartpath("data/gvec_kout/preamble.jld2")
...
for i in 1:lgvec
    ...
    @threads for j in 1:lkoutvec
        ...
        for r in 1:reps
            # @info "Thread $(Threads.threadid()) starting repetition $r"
        ...
        filename = smartpath("data/gvec_kout/g$(i)_kout$(j).jld2")
